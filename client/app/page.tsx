...
export default function Home() {
  ...
  // Fetch all stats from Express backend API
  useEffect(() => {
    async function fetchStats() {
      try {
        ...
        if (result.success && result.data) {
          setStats({
            totalStudents: result.data.students || 0,
            totalBuses: result.data.buses || 0,
            activeBuses: result.data.buses || 0, // synced from backend
            totalRoutes: result.data.routes || 0,
            activeRoutes: result.data.routes || 0,
          });
        }
      } catch (error) {
            ...
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="text-xs text-blue-600 dark:text-blue-400">
                  of {stats.totalRoutes} total zones
                </p>
              </div>
